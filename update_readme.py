...
# Fetch the next tech hack from the list (you can replace this logic with fetching from an API)
def get_next_tech_hack():
    return tech_hacks[0]
...
# Check if there is a "Previous Tech Hacks" section
previous_hacks_section = "## Previous Tech Hacks\n" + content.split("## Previous Tech Hacks\n")[1] if "## Previous Tech Hacks" in content else ""

# Update the README file with today's tech hack
new_hack = f"### {today}\n{get_next_tech_hack()}\n\n"
new_content = f"{new_hack}\n{previous_hacks_section}"
